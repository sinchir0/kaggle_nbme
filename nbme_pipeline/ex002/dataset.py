...
def create_label(cfg, text, annotation_length, location_list):
    ...
    # ncoded = cfg.tokenizer(text, add_special_tokens=True, max_length=cfg.max_len, padding="max_length")
    # TODO: tokeniezerがreturn_offsets_mappingを持たないことによるエラー。roberta-baseのときのoffset_mappinngの返却値を見て、同様の値を返せないか検討
